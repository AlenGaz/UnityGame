...
public class GridTile : MonoBehaviour
{
    ...
    public bool blockingFromSouthToNorth = false;
    public bool blockingFromNorthToSouth = false;
    public bool blockingFromEastToWest = false;
    public bool blockingFromWestToEast = false;
    ...
    {
        GridObject objectAtPos;
        objectAtPos = GridManager.Instance.GetGridObjectAtPosition(m_GridPosition);
        if (objectAtPos != null)
        {
            if (GridManager.Instance.GetGridObjectAtPosition(m_GridPosition).CompareTag("Spell"))
            {          
                return true;
            } 
        }
    ...
    public virtual bool IsTileOccupied() /// ME TRYING TO ADD SPEL TO NOT OCCUPY GRIDSPOT
    {
    ...
    {
        //if(this.gameObject.layer == LayerMask.NameToLayer("AI")) { }
